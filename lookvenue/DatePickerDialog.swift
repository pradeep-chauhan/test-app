...
class DatePickerDialog: UIView {
    ...
    func show(#title: String, datePickerMode: UIDatePickerMode = .Date, callback: ((date: NSDate) -> Void)) {
        show(title: title, doneButtonTitle: "Done", cancelButtonTitle: "Cancel", datePickerMode: datePickerMode, callback: callback)
    }
    
    func show(#title: String, doneButtonTitle: String, cancelButtonTitle: String, defaultDate: NSDate = NSDate(), datePickerMode: UIDatePickerMode = .Date, callback: ((date: NSDate) -> Void)) {
        self.title = title
